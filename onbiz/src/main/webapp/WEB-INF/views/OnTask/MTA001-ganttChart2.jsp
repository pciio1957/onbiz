...
<style>
body { font-family: 'Open Sans', Arial, Helvetica, sans-serif; font-size:12pt;}
...
function memList(no) {
	...
	$(document).ready(function(){
		...
		gantt.config.layout = {
				...
				cols: [
						{ width:580, min_width:580, 
						  rows:[{view: "grid", scrollX: "gridScroll", 
							  scrollable: true, scrollY: "scrollVer"}]
						},
						{resizer: true, width: 1},
						{ width:800, min_width:800,
						  rows:[{view: "timeline", scrollX: "scrollHor", 
							 	  scrollY: "scrollVer"},
		...
		gantt.attachEvent("onLightboxSave", function(id, item){
		    ...
		    console.log("라이트박스의 save!");
		    console.log("입력한 작업시작일 : " + taskStart);
		    console.log("입력한 작업종료일 : " + taskEnd);
		    console.log("프로젝트의 시작일 : " + scaleStart);
		    console.log("프로젝트의 종료일 : " + scaleEnd);
